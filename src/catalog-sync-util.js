...
class CatalogCloneUtil {
    ...
    async postOAuth() {
        ...
        const response = await fetch(`${this.apiRoot}/platform/applications/authtickets/oauth`, {
            method: 'POST',
    ...
    async getCategories(startIndex, pageSize) {
        const response = await fetch(`${this.apiRoot}/commerce/catalog/admin/categories?startIndex=${startIndex}&pageSize=${pageSize}`, {
            method: 'GET',
            headers: this.headers
    ...
    async getProducts(startIndex, pageSize) {
        const response = await fetch(`${this.apiRoot}/commerce/catalog/admin/products?startIndex=${startIndex}&pageSize=${pageSize}`, {
            method: 'GET',
            headers: this.headers,
    ...
    async getTenant(tenantId) {
        ...
        const response = await fetch(`${this.apiRoot}/platform/tenants/${tenantId}`, {
            method: 'GET',
            headers: this.headers,
    ...
    async getSetting(settingName) {
        ...
        if (response.status !== 200) {
            console.log(`Failed to get ${settingName} - site:${this.headers['x-vol-site']} -  ${response.statusText}`);
        } else {
    ...
    async saveSetting(settingName, setting) {
        ...
        if (response.status !== 200) {
            console.log(`Failed to save ${settingName} - site:${this.headers['x-vol-site']}  - ${response.statusText}`);
        } else {
            return await response.json();
        }
    }
    ...
    async saveCategory(categoryId, category) {
        const response = await fetch(`${this.apiRoot}/commerce/catalog/admin/categories/${categoryId}`, {
            method: 'PUT',
            headers: this.headers,
    ...
    async saveProduct(product) {
        const response = await fetch(`${this.apiRoot}/commerce/catalog/admin/products/${product.productCode}?sort=productSequence asc`, {
            method: 'PUT',
            headers: this.headers,
    ...
    async createCategory(category) {
        const response = await fetch(`${this.apiRoot}/commerce/catalog/admin/categories/`, {
            method: 'POST',
            headers: this.headers,
            body: JSON.stringify(category),
    ...
    async getEntityLists() {
        const response = await fetch(`${this.apiRoot}/platform/entitylists?pagesize=200`, {
            method: 'GET',
            headers: this.headers,
    ...
    async getEntities(entityListId, startIndex) {
        ...
        const response = await fetch(`${this.apiRoot}/platform/entitylists/${entityListId}/entities?pagesize=200&startIndex=${startIndex}`, {
            method: 'GET',
            headers: this.headers,
    ...
    async saveEntity(entityListId, entity) {
        let response = await fetch(`${this.apiRoot}/platform/entitylists/${entityListId}/entities/${entity.id}`, {
            method: 'PUT',
            headers: this.headers,
        ...
        if (response.status > 299) {
            response = await fetch(`${this.apiRoot}/platform/entitylists/${entityListId}/entities`, {
                method: 'POST',
                headers: this.headers,
                body: JSON.stringify(entity),
    ...
    async getSearchRedirects() {
        //todo: get all pages
        const response = await fetch(`${this.apiRoot}/commerce/catalog/admin/search/redirect?pagesize=200`, {
            method: 'GET',
            headers: this.headers,
    ...
    async saveSearchRedirects(item) {
        let response = await fetch(`${this.apiRoot}/commerce/catalog/admin/search/redirect/${item.redirectId}`, {
            method: 'PUT',
            headers: this.headers,
        ...
        if (response.status > 299) {
            ...
            response = await fetch(`${this.apiRoot}/commerce/catalog/admin/search/redirect`, {
                method: 'POST',
                headers: this.headers,
                body: JSON.stringify(item),
    ...
    async getSearchMerchandizingRules() {
        //todo: get all pages
        const response = await fetch(`${this.apiRoot}/commerce/catalog/admin/searchmerchandizingrules?pagesize=200`, {
            method: 'GET',
            headers: this.headers,
    ...
    async saveSearchMerchandizingRules(merchRule) {
        let response = await fetch(`${this.apiRoot}/commerce/catalog/admin/searchmerchandizingrules/${merchRule.code}`, {
            method: 'PUT',
            headers: this.headers,
        ...
        if (response.status > 299) {
            ...
            response = await fetch(`${this.apiRoot}/commerce/catalog/admin/searchmerchandizingrules`, {
                method: 'POST',
                headers: this.headers,
                body: JSON.stringify(merchRule),
    ...
    async getSearchSettings() {
        const response = await fetch(`${this.apiRoot}/commerce/catalog/admin/search/settings`, {
            method: 'GET',
            headers: this.headers,
    ...
    async saveSearchSetting(searchSetting) {
        let response = await fetch(`${this.apiRoot}/commerce/catalog/admin/search/settings/${searchSetting.settingsName}`, {
            method: 'PUT',
            headers: this.headers,
        ...
        if (response.status > 299) {
            response = await fetch(`${this.apiRoot}/commerce/catalog/admin/search/settings`, {
                method: 'POST',
                headers: this.headers,
                body: JSON.stringify(searchSetting),
    ...
    mapCategoryIds(categoryMap, productInCatalogSource, productInCatalogsDestination) {
        ...
        if (primaryCategoryId !== null && primaryCategoryId !== undefined) {
            ...
            productInCatalogsDestination.productCategories = this.sortCategoryById(productInCatalogsDestination.productCategories, primaryCategoryId);
        } else {
    ...
    async syncSearchSettings() {
        ...
        for (const sitePair of this.sitePairs) {
            ...
            if (!defaultSearchSetting) {
                console.log(`No default search setting found for catalog ${this.catalogPair.source}`);
                continue;
            }
            this.headers['x-vol-catalog'] = destinationSite.catalogId;
            this.headers['x-vol-site'] = destinationSite.id;
    ...
    async categorySync() {
        ...
        for (const catalogPair of this.catalogPairs) {
            ...
            for (const missingCategoryCode of missingCategoryCodes) {
                ...
                destinationCategoriesDictionary[newCategory.categoryCode] = await this.createCategory(newCategory);
            }
...
async function  main() {
    ...
    const catalogCloneUtil = new CatalogCloneUtil(apiRoot, clientId, clientSecret, masterCatalog, primeCatalog, catalogPairs, sitePairs, tenantId, headers);
